...
if(validaSelect($selectDestino) && validaOpcion($opcionSeleccionada)){
    ...
    echo "<td><select name='".$selectDestino."' id='".$selectDestino."' onChange='cargaContenido(this.id)'>";
    ...
    echo "</select></td>";
    echo "<td><select name='estados2' id='".$selectDestino."' onChange='cargaContenido(this.id)'>";
    echo "<option value='0'>Elige</option>";
    ...
    echo "</select></td>";
    echo "<td><select name='estados3' id='".$selectDestino."' onChange='cargaContenido(this.id)'>";
    echo "<option value='0'>Elige</option>";
