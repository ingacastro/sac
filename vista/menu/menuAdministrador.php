...
<table align="center" class="table-hover">
    ...
    <tr>
        <td align="center" colspan="2">
            <input type="button" class="btn btn-primary btn-flat" onclick="javascript:location.href='../../controlador/coord/consContAdmin.php';" value="Mostrar contingencias" class="btn-box-tool" />
        </td>
     </tr>
    <tr>
